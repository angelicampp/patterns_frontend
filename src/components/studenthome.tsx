...
const sidebarItems = [
  ...
  },
  {
    ...
    badge: "4",
    items: [
      { title: "Asignaciones activas", url: "#", badge: "4" },
      { title: "Archivadas", url: "#" },
      { title: "Completadas", url: "#" },
    ],
  },
  {
    title: "Aprender",
                ...
                <TabsContent value="home" className="space-y-8 mt-0">
                  <section>
                    <motion.div
                      ...
                      className="overflow-hidden rounded-3xl bg-gradient-to-r from-violet-600 via-cyan-600 to-blue-600 p-8 text-white"
                    >
                      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="space-y-4">
                          <h2 className="text-3xl font-bold">¡Bienvenid@ Estudiante!</h2>
                          <p className="max-w-[600px] text-white/80">
                            Desde este panel puede gestionar sus clases, calificaciones y asistencia, además de acceder a 
                            los recursos académicos necesarios para su labor estudiante.
                          </p>
