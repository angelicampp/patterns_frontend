...
export default function LoginPage() {
  ...
  const isForgotFormInvalid = 
    currentView === "forgot" && (!username || usernameError !== "")
  ...
  const handleSubmit = async () => {
    if (currentView === "login") {
      ...
      console.log("Restablecer contraseña para:", username)
    }
  }
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {/* Solo muestra RegisterForm en modo registro */}
              {currentView === "register" ? (
                <RegisterForm />
              ) : (
                <>
                  {/* Campo Email o Nombre de Usuario - Solo para login */}
                  {currentView === "login" && (
                  ...
                  {/* Campo Contraseña - Solo para login */}
                  {currentView === "login" && (
                    <div className="space-y-2">
              ...
              {currentView !== "forgot" && currentView !== "register" && (
                <>
                  <div className="relative">
